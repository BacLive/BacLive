...
// Option for manually-capturing Z-positions, posibility using a button menu
	...
	Dialog.addCheckbox("Pre-Analysis of Channel Intensity Values", false);
	Dialog.show();
...
// DV Confirmation and Processing Menu
	...
	"OPTIONAL: Z-slice start value (0 for autodetect using Start TP):");
	MenuDefaults = newArray(DV,1,TotalTimepoints,10,StartTPMaxSlice);
